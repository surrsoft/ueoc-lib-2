...
(function (UeocAlign) {
  ...
  UeocAlign["END"] = "end";
})(exports.UeocAlign || (exports.UeocAlign = {}));
...
})(exports.UeocAlignS || (exports.UeocAlignS = {}));
...
var UeocAlignSPlus = /*#__PURE__*/function () {
  ...
  UeocAlignSPlus.toCss = function toCss(align) {
    ...
    switch (align) {
      case exports.UeocAlignS.START:
        ret = 'flex-start';
        break;

      case exports.UeocAlignS.CENTER:
        ret = 'center';
        break;

      case exports.UeocAlignS.END:
        ret = 'flex-end';
        break;

      case exports.UeocAlignS.STRETCH:
        ret = 'stretch';
        break;
    }
...
var UeocAlignPlus = /*#__PURE__*/function () {
  ...
  UeocAlignPlus.toCssFormat = function toCssFormat(align) {
    ...
    switch (align) {
      case exports.UeocAlign.START:
        ret = 'flex-start';
        break;

      case exports.UeocAlign.CENTER:
        ret = 'center';
        break;

      case exports.UeocAlign.END:
        ret = 'flex-end';
        break;
    }
...
})(exports.UeocOrient || (exports.UeocOrient = {}));
...
var UeocLayFlex = /*#__PURE__*/function (_UeocElem) {
  ...
  function UeocLayFlex() {
    ...
    _this.vOrientation = exports.UeocOrient.HORIZONTAL;
    _this.vChildsStart = [];
    _this.vChildsStartAlings = [];
    _this.vChildsEnd = [];
    _this.vChildsEndAlings = [];
    _this.vChildBaseAlign = exports.UeocAlign.START;
    return _this;
  }
  ...
  _proto.horizontal = function horizontal(enable) {
    ...
    if (enable) {
      this.vOrientation = exports.UeocOrient.HORIZONTAL;
    }
  ...
  _proto.vertical = function vertical(enable) {
    ...
    if (enable) {
      this.vOrientation = exports.UeocOrient.VERTICAL;
    }
  ...
  _proto.build = function build() {
    ...
    if (this.vOrientation === exports.UeocOrient.VERTICAL) {
      cssOj.flexDirection = 'column';
    } // ---


    var classes = styles.makeStyles({
      container: cssOj
    })();
    ...
    return React.createElement("div", Object.assign({
      ...
      }, index === 0 ? _this2.vOrientation === exports.UeocOrient.HORIZONTAL ? {
        marginLeft: 'auto'
      } : {
        marginTop: 'auto'
      } : {}));
...
var UeocAlignCls = /*#__PURE__*/function () {
  function UeocAlignCls() {
    this.vHorizontaly = exports.UeocAlign.START;
    this.vVerticaly = exports.UeocAlign.START;
  }
...
var UeocTextElem = /*#__PURE__*/function (_UeocElem) {
  ...
  function UeocTextElem() {
    ...
    _this = _UeocElem.apply(this, arguments) || this;
    _this.vText = '';
    _this.vTextAlign = new UeocAlignCls().h(exports.UeocAlign.CENTER).v(exports.UeocAlign.CENTER);
...
exports.UeocAlignCls = UeocAlignCls;
exports.UeocAlignPlus = UeocAlignPlus;
exports.UeocAlignSPlus = UeocAlignSPlus;
